...
class ScreenScannerApp(App):
    def build(self):
        ...
        self.show_data_button = Button(text='Show Scanned Data')
        ...
        self.show_data_button.bind(on_press=self.show_all_screenshots)
        self.layout.add_widget(self.start_button)
        self.layout.add_widget(self.stop_button)
        self.layout.add_widget(self.delete_button)
        self.layout.add_widget(self.show_data_button)
    ...
    def show_all_screenshots(self, instance):
        conn = sqlite3.connect(self.db_path)
        cursor = conn.cursor()
